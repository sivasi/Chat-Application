...
<head>
    ...
    <meta http-equiv="refresh" content="60; URL=personal.php">
    ...
    <div class="myform1">
        ...
        <div class="inner_div" id="chathist">
            ...
            if (isset($_POST['submit'])){
	            ...
	            $sql = "INSERT INTO personal (uname, toname, msg, dt)
	            			VALUES ('$un','$toname' ,'$m',CURRENT_TIMESTAMP())";
            ...
            while($row = mysqli_fetch_array($run)){
                if((($row['uname']==$_SESSION['username'])&&($row['toname']==$toname))||(($row['uname']==$toname)&&($row['toname']==$_SESSION['username']))){
                ...
                <?php
                    ...
                    else if($row['uname']!=$_SESSION['username'])
                    {
                ?>
